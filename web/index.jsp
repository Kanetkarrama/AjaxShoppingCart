<%-- 
    Document   : index
    Created on : 28 May, 2018, 5:08:03 PM
    Author     : Rama
--%>

<%@ page import="java.util.*" %>
<%@ page import="developerworks.ajax.store.*" %>
<!-- Load relevant java packages-->
...
<body>
<!-- specifies the location of catalog to be displayed followed by values of the catalog in a table. The values are picked from java object in the body tag-->
